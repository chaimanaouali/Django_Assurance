...
class EvaluationController extends AbstractController
{
    ...
    {
        return $this->render('admin/base-adminEval.html.twig', [
    ...
    public function new(Request $request, EntityManagerInterface $entityManager): Response
    {
        ...
        return $this->renderForm('admin/base-NewEval.html.twig', [
    ...
    {
        return $this->render('admin/base-ShowEval.html.twig', [
            'evaluation' => $evaluation,
        ]);
    }
    ...
    public function edit(Request $request, Evaluation $evaluation, EntityManagerInterface $entityManager): Response
    {
        ...
        return $this->renderForm('admin/base-EditEval.html.twig', [
            'evaluation' => $evaluation,
            'form' => $form,
        ]);
    }
